...
| 01  | [Gravity prototype](01-gravity-prototype.md)                         | IN PROGRESS | 1a: CPU + tests + render. 1b: WebGPU.     |
...
**Stage 1 — Gravity prototype.** Sub-stage 1a landed (CPU physics, 16 unit tests, Three.js render with 1500 particles). 1b (WebGPU compute, density colouring, 10k @ 60 fps) is next.
